...
function setup(){
    ...
    brain.loadData('mato.json', dataReady);//załadowanie wyuczonego przez komputer kodu 
}

function dataReady(){
    brain.normalizeData(); //wymiary 640x480 muszą być zapisane w przedziale 0-1
    brain.train({epochs: 100}, finished); //program konwertuje 10 razy dane w nim zawarte
}
function finished(){
